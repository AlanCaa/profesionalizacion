...
function iniciarAnimacionesMantenimiento() {
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', iniciarAnimacionesMantenimiento);
} else {
  iniciarAnimacionesMantenimiento();
}
...
document.getElementById('formSolicitud').addEventListener('submit', function(e) {
  ...
  const tipoServicioTexto = tipoServicio === 'preventivo' ? 'Mantenimiento Preventivo' : 
    tipoServicio === 'correctivo' ? 'Mantenimiento Correctivo' : 
    'Soporte Técnico';

  const modalidadTexto = modalidad === 'remoto' ? 'Soporte Remoto' : 'Soporte Presencial';
  const urgenciaTexto = urgencia === 'baja' ? 'Baja (1-3 días)' : 
    urgencia === 'media' ? 'Media (24 horas)' : 
    'Alta (Inmediato)';
  ...
  const resumenHTML = `
    <html>
    <head>
      <title>Solicitud de Servicio - TelloTech</title>
      <style>
        body {
    ...
    <body>
      <div class="solicitud">
        <h2>TelloTech</h2>
        <h3 style="text-align: center; color: #0055aa; margin-bottom: 25px;">Solicitud de Servicio</h3>
        ...
        <div class="info-section">
          ...
          <div class="value">
            ${tipoServicio === 'preventivo' ? 'Mantenimiento Preventivo' : 
              tipoServicio === 'correctivo' ? 'Mantenimiento Correctivo' : 
              'Soporte Técnico'}
          </div>
        </div>
        ...
        <div class="info-section">
          ...
          <div class="value">
            ${modalidad === 'remoto' ? 'Soporte Remoto' : 'Soporte Presencial'}
          </div>
        </div>
