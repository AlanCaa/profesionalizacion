...
document.getElementById('formCotizacion').addEventListener('submit', function(e) {
  ...
  const datosCorreo = {
    nombre,
    correo,
    servicio: 'Almacenamiento en la Nube',
    plan: planSeleccionado,
    duracion: duracionTexto,
...
function iniciarAnimacionesNube() {
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', iniciarAnimacionesNube);
} else {
  iniciarAnimacionesNube();
}
